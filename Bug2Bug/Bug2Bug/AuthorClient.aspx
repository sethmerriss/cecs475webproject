...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
	...
	<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <br />
	    <br />
	    <asp:Button ID="AddAuthorButton" runat="server" Text="Add Author" OnClick="AddAuthorButton_Click" />
	    <br />
	    <br />
	    ...
	    <br />
  	    <br />
	    <asp:Button ID="GetAuthorButton" runat="server" Text="Get Author" OnClick="GetAuthorButton_Click" />
	    <asp:Button ID="btnclear" runat="server" OnClick="btnclear_Click" Text="Clear" />
	    <br />
	    <br />
	    <asp:ListBox ID="resultListBox" runat="server" Width="257px"></asp:ListBox>
	    <br />
	    <br />
	    <br />
	</asp:Content>
